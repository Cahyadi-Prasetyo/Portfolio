                    ...
                    >
                        <Magnet padding={50} disabled={false} magnetStrength={3}>
                            <button
                                ...
                                className={`group p-5 sm:p-6 rounded-full shadow-xl border-2 border-black/20 backdrop-blur-md transition-all duration-300 hover:scale-105 active:scale-95 ${isOpen ? 'bg-white text-black' : 'bg-white text-black hover:bg-black hover:text-white'
                                    }`}
                            >
                                ...
                                <motion.div
                                    ...
                                    className="flex flex-col items-end gap-2 sm:gap-2.5 w-8 sm:w-10"
                                >
