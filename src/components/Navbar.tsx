                    ...
                    >
                        <Magnet padding={50} disabled={false} magnetStrength={3}>
                            <button
                                ...
                                className={`group p-6 md:p-4 rounded-full shadow-xl border-2 border-black/20 backdrop-blur-md transition-all duration-300 hover:scale-105 active:scale-95 ${isOpen ? 'bg-white text-black' : 'bg-white text-black hover:bg-black hover:text-white'
                                    }`}
                            >
                                ...
                                <motion.div
                                    ...
                                    className="flex flex-col items-end gap-2.5 md:gap-1.5 w-10 md:w-7"
                                >
                                    <span className="block h-1 md:h-[3px] w-full bg-current transition-all duration-300 rounded-full" />
                                    <span className="block h-1 md:h-[3px] w-3/4 bg-current transition-all duration-300 group-hover:w-full rounded-full" />
                                    <span className="block h-1 md:h-[3px] w-1/2 bg-current transition-all duration-300 group-hover:w-full rounded-full" />
                                </motion.div>
                            </button>
                        </Magnet>
                    </motion.div>
