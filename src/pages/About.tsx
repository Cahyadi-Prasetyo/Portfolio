    ...
    return (
        <div className="pt-32 pb-20 px-6 min-h-screen bg-white">
            <div className="max-w-7xl mx-auto flex flex-col-reverse lg:flex-row gap-12">
                ...
                {/* Sidebar / Lanyard */}
                <div className="lg:w-80 flex-shrink-0 lg:h-[600px] sticky top-32">
                    <ScrollReveal delay={0.4}>
                        <div className="w-full h-[500px] lg:h-full relative rounded-2xl overflow-hidden bg-gray-50/50">
                            {/* 3D Lanyard - Interactive Card */}
